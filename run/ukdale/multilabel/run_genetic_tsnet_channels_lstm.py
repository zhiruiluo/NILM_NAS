...
from src.search.nas_problem_with_channel_lstm import get_tsnet_problem_with_channels_lstm
...
class Searcher():
    ...
    def search(self):
        ...
        problem, algorithm, checkpoint = get_tsnet_problem_with_channels_lstm(
