...
def loop(args: MyProgramArgs):
    ...
    space = {
        ...
        "datasetConfig": {
            ...
            "train_house_no": tune.grid_search([[2,3,4,6],[2,3]]),
            "stride": tune.grid_search([5]),
            "drop_na_how": 'all',
        },
        "modelConfig":{
            ...
            "bit_string": tune.grid_search(["11001111111010111111010101011100111000000111101101011001100111101000111101001110000111111101011111010110"]),
            "out_channels": tune.grid_search([32,64,128,256]),
            # "head_type": tune.grid_search(["Focal","ASL"]),
            "head_type": tune.grid_search(["MaskFocal"]),
        } 
        # {"nclass": 4, "n_phases": 3, "n_ops": 3, "bit_string": "001001101001101011101000011010001100110", "in_channels": 2, "out_channels": 32, "dropout": 0.5}
    }
