...
def test_get_dataset():
    df_house = get_dataset(1, "data/low_freq", [5, 6, 11, 20], sample_seconds=6, drop_na_how='any')
    print(df_house.shape)
    print(np.isnan(df_house.to_numpy()))
    df_house = get_dataset(1, "data/low_freq", [5, 6, 11, 20], sample_seconds=6, drop_na_how='all')
    print(df_house.shape)
    print(np.isnan(df_house.to_numpy()).all())
